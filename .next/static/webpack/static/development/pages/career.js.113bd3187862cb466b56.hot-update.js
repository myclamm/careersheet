  ...
  function NavBar(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "toggleBurger", function () {
      _this.setState({
        ...
        background: !_this.state.collapsed ? background : "rgb(1,149,166,0.8)"
      });
    });

    var _background = _this.props.background;
    _this.state = {
      collapsed: true,
...
//# sourceMappingURL=career.js.113bd3187862cb466b56.hot-update.js.map